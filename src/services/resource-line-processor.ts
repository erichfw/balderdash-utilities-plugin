...
export class ResourceProcessor {
    ...
    : Promise<string> {
        ...
        console.debug(`The resource line is:`, line);
        ...
        this.settings.myResourceAliases.filter(t => line.includes(t)).forEach(async t => await fileToHeader(newLine,resourceFile,t.replace("#","# ")));
